...
def freeze_graph_with_def_protos(
  ...
  with tf.Graph().as_default():
    ...
    if optimize_graph:
      ...
      #rewrite_options = rewriter_config_pb2.RewriterConfig(optimize_tensor_layout=True) # ADDED BY GUSTAV
    ...
    config = tf.ConfigProto(graph_options=tf.GraphOptions()) #HEAD
